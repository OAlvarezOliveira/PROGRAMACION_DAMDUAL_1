    ...
    public static void main(String[] args) {
        ...
        while (procesa) {
            ...
            while (dia <= 6 && procesa) {
                ...
                if (ventasDia == -1) {
                    ...
                    if (ventasDia > importeMasVentas) {
                        ...
                        if (dia == 1) diaMasVentas = "MARTES";
                        else if (dia == 2) diaMasVentas = "MIERCOLES";
                        else if (dia == 3) diaMasVentas = "JUEVES";
                        else if (dia == 4) diaMasVentas = "VIERNES";
                        else if (dia == 5) diaMasVentas = "SABADO";
                        else if (dia == 6) diaMasVentas = "DOMINGO";
                    ...
                    if (ventasDia < importeMenosVentas) {
                        ...
                        if (dia == 1) diaMenosVentas = "MARTES";
                        else if (dia == 2) diaMenosVentas = "MIERCOLES";
                        else if (dia == 3) diaMenosVentas = "JUEVES";
                        else if (dia == 4) diaMenosVentas = "VIERNES";
                        else if (dia == 5) diaMenosVentas = "SABADO";
                        else if (dia == 6) diaMenosVentas = "DOMINGO";
            ...
            if (dia == 7) {
                ...
                if (contadorMax > 1) diaMasVentas = "EMPATE";
                if (contadorMin > 1) diaMenosVentas = "EMPATE";
