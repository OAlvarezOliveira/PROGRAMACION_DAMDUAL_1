...
public class Ejercicio10B {
	...
	private static boolean contrasinalForte(String passw) {
		...
		esFuerte = comprobarMayus(passw, letras, esFuerte);
		esFuerte = comprobarMinusc(passw, letras, esFuerte);
		esFuerte = comprobarNumeros(passw, numeros, esFuerte);

		return esFuerte;

	}

	private static boolean comprobarNumeros(String passw, String numeros, boolean esFuerte) {
		int cont;
		// Comprobamos números
		cont = 0;
	...
	private static boolean comprobarMinusc(String passw, String letras, boolean esFuerte) {
		int cont;
		// Comprobo minúsculas
	...
	private static boolean comprobarMayus(String passw, String letras, boolean esFuerte) {
		int cont;
		// Comprobo mayúsculas
		cont = 0;
		for (int i = 0; i < passw.length(); i++) {
